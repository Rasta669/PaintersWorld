...
- ```Purple``` for normal platform.
- ```Yellow```, you player moves with enhanced speed.
...
This project is licensed under the Dual Licensing model. See the [LICENSE](LICENSE) file for details.
